...
class TestLogin:
    ...
    def login_helper(driver):
        driver.find_element(By.CSS_SELECTOR, '[name="name"]').send_keys(data_for_test.user_email)
        driver.find_element(By.CSS_SELECTOR, '[type="password"]').send_keys(data_for_test.user_password)
